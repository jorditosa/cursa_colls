    ...
    <>
      <section className="font-Poppins pt-20 md:pt-24">
        ...
        <div className="w-full lg:max-w-[1000px] mx-auto pb-20 pt-5 px-3 border-l-8 border-l-curta">
          <p className='py-5'>
          La Curta té el recorregut ideal per iniciar-se al Trail running o per donar via lliure a la velocitat dels corredors més ràpids. La sortida es realitzarà des de la llotja de pescadors del port de Vilanova. Només començar trobarem la pujada asfaltada a l’Ermita de Sant Cristòfol, creuarem la via i enfilarem les pistes de terra que ens endinsaran al parc dels Colls Miralpeix.
          </p>
          <p className='py-5'>
          El recorregut te dues pujades no gaire llargues però si que són exigents si voleu córrer! Hi ha trams de baixada que són tècnics i per tant cal anar en compte. A partir del cinquè quilòmetre vorejarem la costa Vilanovina fins arribar a la línia d’arribada a la platja del Far.
          </p>
          <a 
        ...
        <div className="w-full lg:max-w-[1000px] mx-auto pb-20 pt-5 px-3 border-l-8 border-l-llarga">
          <p className='py-5'>
          Lla Llarga és una prova que consta de gairebé 15 km amb un desnivell aproximat de 500 metres positius. Un autèntic trencacames que puja i baixa els turons que tenim a tocar del mar entre Vilanova i Sitges. La línia de sortida es realitzarà al costat de la llotja del port de pescadors de Vilanova, una sortida ràpida en asfalt que a partir del primer quilòmetre ja busca les pistes de terra que ens endinsen al parc dels Colls Miralpeix.
          </p>
          <p className='py-5'>
