                ...
                <form action="#">
                    <div className="items-center mx-auto mb-3 space-y-4 w-full md:w-1/2 sm:flex sm:space-y-0">
                        <div className="relative w-full">
                            ...
                            <div className="flex absolute bg-primary border-4 border-secondary inset-y-0 left-0 items-center px-2 pointer-events-none rounded-l-md">
                                <svg className="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg>
                            </div>
                            <input className="block text-dark p-3 pl-12 w-full text-sm bg-gray-50 rounded-lg border-4 border-secondary sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Introdueix el teu email" type="email" id="email" required="" />
                        </div>
                        <div>
                            <button type="submit" className="py-3 px-5 w-full text-sm font-medium text-center text-light rounded-lg border cursor-pointer bg-primary border-4 border-secondary sm:rounded-none sm:rounded-r-lg hover:bg-primary-800">Enviar</button>
                        </div>
                    </div>
